...
func (r *Router) Setup() http.Handler {
	...
	mux.Handle("/api/v1/public/webdav/group/members/name", r.createAuthenticatedHandler(http.HandlerFunc(r.groupHandler.HandleMemberNameUpdate)))
	mux.Handle("/api/v1/public/webdav/group/members/alias", r.createAuthenticatedHandler(http.HandlerFunc(r.groupHandler.HandleMemberAliasUpdate)))
	...
	mux.Handle("/api/v1/public/webdav/address/members/name", r.createAuthenticatedHandler(http.HandlerFunc(r.groupHandler.HandleMemberNameUpdate)))
	mux.Handle("/api/v1/public/webdav/address/members/alias", r.createAuthenticatedHandler(http.HandlerFunc(r.groupHandler.HandleMemberAliasUpdate)))
