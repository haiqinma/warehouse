...
本文只描述 Warehouse V1 已经实现的基础架构事实。V2 已实现的自愈、观测、限流和运维治理见 [系统架构-V2.md](系统架构-V2.md)，未实现的自动编排和正式多副本见 [系统架构-V3.md](系统架构-V3.md)。
...
WebDAV 单次请求的权限、配额、回收站、MOVE/COPY 细节见 [WebDAV请求处理流程.md](../../应用集成/WebDAV请求链路.md)。
...
详细路径和权限边界见 [资产空间分层方案.md](../能力设计/资产空间.md)。
...
共享的产品模型和演进细节见 [共享方案.md](../能力设计/共享与授权.md)。
...
完整多副本设计见 [多副本方案.md](../能力设计/高可用与多副本.md)。
...
其中 reconcile 自愈和运维治理已由 [系统架构-V2.md](系统架构-V2.md) 实现；自动 failover、正式多副本和上层 Knowledge 控制面仍属于 [系统架构-V3.md](系统架构-V3.md) 或后续版本。
