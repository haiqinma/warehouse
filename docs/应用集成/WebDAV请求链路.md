...
- 服务整体模块划分、容器初始化、路由装配：见 [系统架构-V1.md](../产品架构/架构演进/系统架构-V1.md)
- 认证方式、UCAN、访问密钥、管理员能力：见 [身份认证.md](../产品架构/能力设计/身份认证.md)
- 回收站对外 API、分享接口：见 [Warehouse OpenAPI](../应用集成/OpenAPI/接口契约说明.md)
...
更完整的权限模型与认证边界，见 [身份认证.md](../产品架构/能力设计/身份认证.md)。
